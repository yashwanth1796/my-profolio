		...
		<LazyMotion features={domAnimation}>
			<Box as="section" id="about" className="section">
				...
				<Flex direction="column" gap={3} pt={10} pb={16} maxW="5xl">
					...
					>
						My name is Yashwanth. I have been a front-end developer for 5+ years. I have started my
						programming journey as Angular developer. Now I&apos;m in love with React and Next.js.
